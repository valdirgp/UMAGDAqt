from PyQt5.QtWidgets import QWidget, QVBoxLayout, QLabel, QListWidget, QComboBox, QPushButton, QCalendarWidget
...
class SideOptionsCalmDisturb(QWidget):
    def __init__(self, parent=None, language='en'):
        ...
        self.create_calmdisturb_plot_options()
    ...
    def create_calmdisturb_plot_options(self):
        ...
        # Disturb date selection
        self.layout.addWidget(QLabel(self.util.dict_language[self.lang]['lbl_disturb']))
        self.cal_disturb.selectionChanged.connect(lambda: self.add_date(self.cal_disturb, self.selected_disturb_dates))
        self.layout.addWidget(self.cal_disturb)
