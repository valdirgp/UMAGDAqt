...
from PyQt5 import QtWidgets  # Import necessário para manipular widgets PyQt5
...
class Util():
    ...
    # PyQt5 version: destroy every existent QFrame in the root widget
    def destroy_existent_frames(self, root):
        # Remove all QFrame children of root
        for widget in root.findChildren(QtWidgets.QFrame):
            widget.setParent(None)
            widget.deleteLater()

    # calculates magnetic equator based in given longitude and latitude
